...
const EnterpriseLeadershipMessageScreen = () => {
  ...
  const recentMessages: { id: number; title: string; date: string; tag: string }[] = [];
  const cultureQuotes: { text: string; id: number }[] = [];
      ...
      <main className="px-6 space-y-8 max-w-4xl mx-auto py-8">
        ...
        <section className="space-y-4">
          ...
          <div className="bg-white rounded-3xl p-8 border border-[#0B0908]/5 shadow-sm">
            <p className="text-[13px] text-[#999] italic">
              Nenhum comunicado publicado ainda. Use o formulário abaixo para criar o primeiro comunicado editorial.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          {recentMessages.length === 0 ? (
            <p className="text-[13px] text-[#999] italic">Nenhuma mensagem publicada.</p>
          ) : (
        ...
        <section className="space-y-4">
          ...
          {cultureQuotes.length === 0 ? (
            <p className="text-[13px] text-[#999] italic">Nenhuma frase de referência configurada ainda.</p>
          ) : (
