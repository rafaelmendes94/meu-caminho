...
const items = [
  ...
  { to: "/admin/content/library", label: "Content — Biblioteca" },
  { to: "/admin/content/books", label: "Content — Livros" },
  { to: "/admin/content/courses", label: "Content — Cursos" },
  { to: "/admin/content/tracks", label: "Content — Trilhas" },
  { to: "/admin/content/podcasts", label: "Content — Podcasts" },
  { to: "/admin/content/videos", label: "Content — Vídeos" },
  { to: "/admin/content/audios", label: "Content — Áudios" },
  { to: "/admin/content/materials", label: "Content — Materiais" },
  { to: "/admin/content/collections", label: "Content — Coleções" },
