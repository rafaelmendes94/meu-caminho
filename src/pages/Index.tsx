...
const Index = () => {
  ...
  const isDesktop = useIsDesktop();;  const [mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const();mode, setMode] = useState<"choose" | "email" | "signup">("choose");
;()const  const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth(); isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();const { isAuthenticated, signInWithGoogle, signInWithPassword, signUp, roles, hasEmployeeProfile, loading } = useAuth();
  const [mode, setMode] = useState<"choose" | "email" | "signup">("choose");const [mode, setMode] = useState<"choose" | "email" | "signup">("choose");
